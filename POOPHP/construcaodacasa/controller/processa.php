...
if($_SERVER['REQUEST_METHOD']  === 'POST'){
    ...
    switch($acao){
        ...
        case 'finalizar_casa':
            ...
            $casa->setListaDeJanela($listaJanela);
            ...
            echo "<h3>Janelas:</h3>";
            foreach($casa->getListaDeJanela() as $janela){
                $estado = $janela->getEstado() == 1 ? "Aberta" : "Fechada";
                echo "<p>{$janela->getDescricao()} - {$estado}</p>";
            }
            echo '<br>< href="index.html">Voltar ao menu</a>';
            break;
        ...
        case 'selecionar_abertura':
            ...
            $lista = ($tipo === 'porta') ? $casa->getListaDePortas() : $cas->getListaDeJanelas();
            ...
            <form  >
                ...
                echo "<select>
                <button type='submit'>Avançar</button><br>
                </select></form><br>
                <a href='index.html'> Voltar ao menu</a>";
        break;
